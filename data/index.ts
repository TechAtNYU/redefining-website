...
export const selectEvents = [
  ...
  },
  {
    ...
    des: "Ready to learn a valuable software skill? Join us for a workshop on Figma, a powerful design tool to create responsive UI's and designs.",
    img: "/p4.svg",
...
export const StartupGridItems = [
  {
    id: 1,
    title: "Our iconic StartupWeek Social!",
    description: "",
    className: "lg:col-span-3 md:col-span-6 md:row-span-4 lg:min-h-[60vh]",
    imgClassName: "w-full h-full",
    titleClassName: "justify-end",
  ...
  {
    id: 4,
    title: "Animation and Game Design Panel",
    description: "",
