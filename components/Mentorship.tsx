  ...
  const data = [
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Connect with assigned mentor and follow either structured resume and
            professional development plan or work on custom plan together.
          </p>
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Projects are mostly completed, mentee begins networking strategies
            and job search.
          </p>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Resumes are polished and cover letters are written. Mentee begins to
            apply to jobs as need be.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-4">
            Showcase growth by seeing progress from the checkin forms being
  ...
  const MGridItems = [
    {
      title: "Mentee",
      description:
        "A small cohort of dedicated passionate developers who seek help in building their profiles and projects with paired 1:1 mentorship.",
      icon: <IconCurrencyDollar />,
    },
    {
      title: "Mentors",
      description:
        "From recent grads at F500 companies and top firms to senior engineers and founders at startups, they will guide you to success! From resume reviews to mock interviews, they will help you land a job at some of the most challenging companies.",
  ...
  return (
    <div className="w-full md:w-[80%] justify-center px-10">
      <p className="md:text-base text-sm md:font-normal font-light w-[60%] text-center justify-self-center">
        One of our most popular programs, Mentorship is a staple proram that
        aims to provide industry support to students seeking to break into the
        tech industry. Mentors are carefully selected from a pool of top
        companies and startups are paired with mentees to provide guidance and
      ...
      <div className="flex flex-col items-center max-lg:mt-10 pb-20">
        ...
        <h1 className="heading py-10">
          <span className="text-purple">Mentor Representation</span>
        </h1>
